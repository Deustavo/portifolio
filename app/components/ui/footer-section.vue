...
<template>
  <footer class="relative overflow-hidden bg-black" style="min-height: 60vh;">
    ...
    <UiAnimatedGradientBackground
      ...
      :gradient-colors="['#000000', '#0d0d1a', '#111827', '#1a0a2e', '#0f172a', '#050510', '#000000']"
    ...
    <div class="relative z-10 flex flex-col items-center justify-center h-full px-6 py-24 text-center" style="min-height: 60vh;">
      ...
      <h2
        ...
        class="text-4xl md:text-6xl font-semibold text-white tracking-tight mb-4 max-w-2xl"
      >
        {{ copy.headline }}
      </h2>

      <!-- Sub -->
      <p :style="fontInter" class="text-base text-white/40 mb-10">
        {{ copy.sub }}
      </p>
      ...
      <a
        ...
        :style="fontInter"
        class="inline-flex items-center gap-2 px-7 py-3.5 rounded-full border border-white/20 text-white/80 text-sm font-medium hover:bg-white/10 hover:border-white/40 hover:text-white transition-all duration-300 backdrop-blur-sm"
      >
        {{ copy.cta }}
      ...
      <!-- Divider -->
      <div class="mt-16 mb-8 w-px h-12 bg-gradient-to-b from-transparent via-white/20 to-transparent" />
      ...
      <div class="flex items-center gap-6 mb-12">
        <a
          ...
          class="text-white/30 hover:text-white/80 transition-colors duration-300"
          aria-label="GitHub"
        >
          <Github :size="20" />
        </a>
      ...
      <!-- Copyright -->
      <p :style="fontInter" class="text-xs text-white/20 tracking-wide">
